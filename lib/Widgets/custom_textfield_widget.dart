  ...
  Widget build(BuildContext context) {
    InputBorder? getBorder({double? radius,Color? color}){
      ...
      return OutlineInputBorder(
        ...
        borderSide: BorderSide(color: color ?? ThemeClass.of(context).darkGrey,width: 1),
      );
    }
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: hint,
          labelText: enableLabel? hint:null,
          ...
          contentPadding: insidePadding?? EdgeInsets.symmetric(vertical: 0.h, horizontal: 28.w),
          
          hintStyle: hintStyle ?? TextStyleHelper.of(context).s_14Reg.copyWith(color: ThemeClass.of(context).darkGrey),),
        
        onChanged: onchange,
        textCapitalization: TextCapitalization.words,
        maxLines: expands == true ?null:maxLine ?? 1,
        minLines: expands == true ?null:minLines?? 1 ,
        keyboardType: textInputType,
        style: style ?? TextStyleHelper.of(context).s_14Reg.copyWith(color: ThemeClass.of(context).darkGrey),
      ),
    );
  }
}
